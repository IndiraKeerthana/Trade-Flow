    ...
    return (
        <div className="container p-5 mb-5 px-3">
            <div className="row text-center">
                <img src="/media/homeHero.png" alt="Hero Image"  className = "mb-2" style = {{width: "65%", margin: "0 auto"}}></img>
                <h1 className="mt-5 fs-3 mb-2" style = {{color: "#424242", fontSize: "1.75rem"}}>Invest in everything</h1>
