...
function Hero() {
    return (
        <div className="container">
            <div className="row p-5 mb-5 mt-4" style={{ color: "#424242" }}>
            ...
            <div className="row p-5 mt-5 border-top text-muted me-5 ms-5" style = {{lineHeight: "1.8", fontSize: "1rem", color: "#424242"}}>
